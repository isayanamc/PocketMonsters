document.addEventListener('DOMContentLoaded', ()=> {
    ...
    button.addEventListener('click', () => {
        ...
        if (emailTesteado){
            ...
            .then(resultado =>{
                document.getElementById('divprincipal').innerHTML = `<div style="text-align: center;"><div><h1>${resultado['mensaje']}</h1><img src="../public/images/pikaFeliz.png" alt="pikaFeliz" style="width: 200px; height: auto;"></div></div>`;
